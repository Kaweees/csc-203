...
public class SimpleArray {
   ...
   * Boolean values to tell us if they are above a certain threshold. For
   * example, if the applicant's scores are [80, 85, 89, 92, 76, 81], and the
  ...
  public static boolean[] applicantAcceptable(int[] scores, int threshold) {
     ...
     * appropriate boolean (true or false) value. Write a loop to compute the
     * acceptability of the scores based on the threshold and place the result
     * into into the output array.
     */
