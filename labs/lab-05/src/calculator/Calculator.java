public class Calculator {
  ...
  public Calculator(final String header, final String prompt, final Parser parser, final Bindings bindings) {
    this.header = header;
    this.prompt = prompt;
    this.parser = parser;
  ...
  public static void main(String[] args) {
    new Calculator(STANDARD_HEADER, STANDARD_PROMPT, new Parser(new Scanner()), new VariableBindings()).calculate();
    System.out.println();
  }
}
