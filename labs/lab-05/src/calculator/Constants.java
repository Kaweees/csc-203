...
public class Constants {
  public static final int LEXEME_FIRST = 0, // should match the first entry in
                                            // lexemes
      TK_LPAREN = 0, TK_RPAREN = 1, TK_ASSIGN = 2, TK_SET = 3, TK_PLUS = 4, TK_MINUS = 5, TK_TIMES = 6, TK_DIVIDE = 7,
      TK_NEWLINE = 8, TK_EOF = 9, // last in lexemes
      // the following correspond to sets of tokens
      TK_ID = 10, TK_NUM = 11, TK_NONE = 12,
  ...
  static final String[] lexemes = { "(", ")", "=", "set", "+", "-", "*", "/", "\n", "*EOF*" };
