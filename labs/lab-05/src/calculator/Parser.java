...
public class Parser {
  ...
  public Operation parse() throws InvalidOperationException {
    nextToken();
    return parseOperation();
  }

  private Operation parseOperation() throws InvalidOperationException {
    Operation op = null;
  ...
  private Assignment parseSet() throws InvalidOperationException {
  ...
  private Expression parseExpression() throws InvalidOperationException {
  ...
  private Expression parseUnaryNegation() throws InvalidOperationException {
  ...
  private String matchIdentifier() throws InvalidOperationException {
  ...
  private void match(final int tkcode) throws InvalidOperationException {
  ...
  private void expected(final String msg) throws InvalidOperationException {
    ...
    clearLine();
    throw new InvalidOperationException("expected " + msg + ", got '" + tk + "'");
  }

  private void expectNewline() throws InvalidOperationException {
    if (currentTokenCode() != Constants.TK_NEWLINE) {
      clearLine();
      throw new InvalidOperationException("unexpected symbols after expression");
    }
  }
