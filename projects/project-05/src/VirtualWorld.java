...
public final class VirtualWorld extends PApplet {
  ...
  public void mousePressed() {
    ...
    System.out.println("Tile: " + world.getTileType(pressed));

    Optional<Entity> entityOptional = world.getOccupant(pressed);
    
    if (entityOptional.isPresent() || world.isOccupied(pressed)) {
      System.out.println("Occupant: " + entityOptional);
      Entity entity = entityOptional.get();
      System.out.println(entity.getId() + ": " + entity.getClass() + " : " + entity.getClass());
    }
    // check if
    
    else if (world.getTileType(pressed).equals("grass") || world.getTileType(pressed).equals("flowers")) {
      // create a grave at mouse position if tile is grass
      Grave grave = new Grave("grave", pressed, imageStore.getImageList("grave"));
  ...
  public void scheduleActions(WorldModel world, EventScheduler scheduler, ImageStore imageStore) {
    for (Entity entity : world.getEntities()) {
      if (entity instanceof hasAnimations) {
        ((hasAnimations) entity).scheduleActions(scheduler, world, imageStore);
      }
    }
  }
