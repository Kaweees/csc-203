...
public final class WorldView {
  ...
  public void shiftView(int colDelta, int rowDelta) {
    int newCol = clamp(viewport.getCols() + colDelta, 0, world.getNumCols() - viewport.getNumCols());
    int newRow = clamp(viewport.getRows() + rowDelta, 0, world.getNumRows() - viewport.getNumRows());
