...
public class WorldTests {
  ...
  public void testTryAddEntity() {
    ...
    assertThrows(IllegalArgumentException.class, () -> VirtualWorld.headlessMain(new String[] { sav }, 1));
  }
  ...
  public void testTrampleFull() {
    String sav = makeSave(1, 6, "tree  0 0 100.0 100.0 1", "dude  1 0 0.300 100.0 1", "stump mystump 3 0",
        "house  5 0");
    List<String> entities = VirtualWorld.headlessMain(new String[] { sav }, 10);
    assertEquals(0, entities.size());
  }
  ...
  public void testFairyPathing() {
    String sav = makeSave(15, 20, "fairy myfairy 10 9 100.0 0.300", "obstacle  9 11 1.126", "obstacle  10 12 1.126",
        "obstacle  11 11 1.126", "stump  10 14", "stump  0 0", "house  10 8");
    List<String> entities = VirtualWorld.headlessMain(new String[] { sav }, 5);
  ...
  public void testDudeLimit() {
    String sav = makeSave(5, 20, "dude mydude 1 1 0.300 100.0 4", "tree  1 2 100.0 0.020 1", "tree  2 2 100.0 0.020 1",
        "tree  3 2 100.0 0.020 1", "tree  4 2 100.0 0.020 1", "tree  5 2 100.0 0.020 1", "tree  6 2 100.0 0.020 1");
    List<String> entities = VirtualWorld.headlessMain(new String[] { sav }, 8);
  ...
  public void testDudePathing() {
    String sav = makeSave(15, 20, "dude mydude 10 9 1.000 100.0 1", "obstacle  11 11 1.126", "obstacle  10 12 1.126",
        "obstacle  9 11 1.126", "tree  10 14 0.250 1.150 2", "tree  0 0 0.250 1.150 2", "house  10 8");
    List<String> entities = VirtualWorld.headlessMain(new String[] { sav }, 8);
  ...
  public void testDudeTransformFull() {
    String sav = makeSave(3, 5, "dude mydude 1 1 0.500 100.0 1", "tree  0 1 0.250 0.001 1", "house  4 1",
        "tree  4 2 0.250 0.001 1");
    List<String> entities = VirtualWorld.headlessMain(new String[] { sav }, 5);
